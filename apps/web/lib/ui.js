...
export const modalCard =
  "relative w-full max-w-sm animate-[modal-card-in_0.26s_var(--ease-out)_both] rounded-lg border border-border bg-surface p-7 shadow-lg max-h-[calc(100dvh-2rem)] overflow-y-auto max-md:max-h-[min(90dvh,100%)] max-md:overflow-y-auto max-md:p-5 max-md:rounded-b-none max-md:rounded-t-xl";
...
export const gameTutorialCard = cn(
  ...
  "max-h-[calc(100dvh-2rem)] overflow-y-auto max-md:max-h-[min(90dvh,100%)] max-md:overflow-y-auto max-md:rounded-t-xl max-md:rounded-b-none"
);
...
export const gameTutorialHelpBadge =
  "mx-0.5 inline-flex h-[1.35em] w-[1.35em] -translate-y-[0.05em] items-center justify-center rounded-full border border-white bg-white text-[0.8em] font-bold leading-none text-slate-900 align-middle";
...
export const gameTutorialTooltipMobileSheet = cn(
  gameTutorialTooltip,
  "fixed inset-x-3 bottom-[max(0.75rem,env(safe-area-inset-bottom))] left-3 right-3 top-auto",
  "max-h-[min(42dvh,100%)] overflow-y-auto rounded-t-xl"
);
...
export const gameMetaTagButton = cn(
  gameMetaTag,
  "inline-flex cursor-pointer items-center border-0 font-[inherit]",
  "transition-[background,color,transform] duration-150 ease-out",
  "hover:bg-menu-hover hover:text-text active:scale-[0.98]",
  focusRing
);

export const modalScore = "m-0 mb-1.5 text-[2rem] font-bold text-success";

export const modalGameContext =
  "m-0 mb-4 flex flex-wrap items-baseline gap-y-0.5 text-base text-text-muted";

export const modalGameContextPart = "whitespace-nowrap";
...
/** Colored game-type choices — brand teal / accent blue / Go green. */
export const gameTypeBtnDiscover =
  "border-[var(--color-header-teal)]/55 bg-[var(--color-header-teal)]/18 shadow-[0_0_0_1px_color-mix(in_srgb,var(--color-header-teal)_20%,transparent)] enabled:hover:border-[var(--color-header-teal)]/75 enabled:hover:bg-[var(--color-header-teal)]/28";

export const gameTypeBtnTest =
  "border-accent/55 bg-accent-soft shadow-[0_0_0_1px_var(--color-accent-soft)] enabled:hover:border-accent/75 enabled:hover:bg-accent-soft/80";

export const gameTypeBtnLearn =
  "border-green-500/55 bg-green-500/18 shadow-[0_0_0_1px_rgba(34,197,94,0.18)] enabled:hover:border-green-500/75 enabled:hover:bg-green-500/28";
...
export const accountUploadProgress = "mt-4 w-full max-w-[220px]";

export const accountUploadProgressLabel =
  "mb-1.5 flex items-center justify-between text-[0.75rem] font-medium text-text-muted";

export const accountUploadProgressTrack =
  "h-2 w-full overflow-hidden rounded-full bg-inset ring-1 ring-inset ring-border-subtle";

export const accountUploadProgressBar =
  "h-full rounded-full bg-accent transition-[width] duration-200 ease-out";

export const avatarCropModalCard = cn(modalCard, "max-w-md");

export const avatarCropViewport =
  "relative mx-auto aspect-square w-full max-w-[280px] touch-none select-none overflow-hidden rounded-full bg-inset ring-2 ring-border cursor-grab active:cursor-grabbing";

export const avatarCropImage =
  "pointer-events-none absolute left-1/2 top-1/2 max-w-none origin-center will-change-transform";

export const avatarCropHint =
  "mt-3 text-center text-[0.85rem] text-text-muted";

export const avatarCropZoomRow =
  "mt-4 flex items-center gap-3";

export const avatarCropZoomLabel =
  "shrink-0 text-[0.8rem] font-semibold text-text-muted";

export const avatarCropZoomInput =
  "h-2 w-full cursor-pointer accent-[var(--color-accent)]";

export const avatarCropActions =
...
export const startHeroTitleGroup =
  "start-hero-title-group flex flex-col items-center gap-0";
...
export const startTitleGlobe =
  "start-title-globe font-brand m-0 text-center font-light leading-[1.05] tracking-[0.02em] text-[clamp(4.5rem,24vw,14rem)]";
...
export function startModeBtn({ selected = false, disabled = false, className } = {}) {
  return cn(
    choiceBtn({ selected: false, disabled }),
    "start-mode-btn border-2 shadow-none",
    selected && "start-mode-btn--selected text-text focus-visible:outline-none",
    className
  );
}
...
export const startLevelList = "mx-auto w-full max-w-md";

export const startLevelSections =
  "mx-auto grid w-full max-w-[44rem] grid-cols-2 grid-rows-[auto_auto_auto] justify-center justify-items-center gap-x-8 gap-y-3 max-[36rem]:grid-cols-1 max-[36rem]:grid-rows-none max-[36rem]:gap-6";

export const startLevelSection =
  "grid min-w-0 w-full grid-rows-subgrid row-span-3 gap-3 max-[36rem]:flex max-[36rem]:flex-col max-[36rem]:items-center max-[36rem]:row-auto";

export const startLevelSectionHeader =
  "flex min-w-0 w-full flex-col items-center gap-1.5 max-[36rem]:contents";
...
export const startLevelSectionList =
  "mx-auto grid w-full max-w-none grid-rows-subgrid row-span-2 items-stretch gap-3 max-[36rem]:flex max-[36rem]:max-w-md max-[36rem]:flex-col max-[36rem]:row-auto";
...
export const exploreBtn = cn(
  "w-full items-center border-[var(--color-header-teal-border)] bg-app-header text-center text-[#f0fdfa]",
  "enabled:hover:border-[var(--color-header-teal-border)] enabled:hover:bg-[var(--color-header-teal-border)]",
  "max-md:px-4 max-md:py-3"
);

export const exploreBtnDesc =
  "text-sm font-medium leading-snug text-[rgba(240,253,250,0.85)] max-md:text-[0.78rem]";
...
export const gameHeaderRightMobilePlay =
  "md:col-start-3 md:flex md:items-center md:justify-self-end md:gap-4 max-md:grid max-md:w-full max-md:grid-cols-[1fr_auto_1fr] max-md:items-center max-md:gap-2 max-md:[grid-area:right]";

export const gameHeaderActions = "flex items-center gap-2.5 max-md:gap-2";

export const gameHeaderTimerMobile =
  "hidden justify-self-center font-variant-numeric tabular-nums text-[0.9rem] font-semibold text-text-muted max-md:inline";
...
export const prompt = "text-3xl font-semibold leading-tight max-md:text-2xl";
...
export const discoverMapLabelTextShadow = [
  "0 0 2px rgb(236 240 244 / 1)",
  "0 1px 3px rgb(226 232 240 / 0.95)",
  "1px 0 0 rgb(226 232 240 / 0.9)",
  "-1px 0 0 rgb(226 232 240 / 0.9)",
  "0 -1px 0 rgb(226 232 240 / 0.9)",
].join(", ");

export const discoverMapLabelText = cn(
  "inline-block w-fit max-w-[10rem] overflow-visible whitespace-nowrap",
  "font-brand text-[0.8125rem] font-semibold leading-snug tracking-[0.01em] text-black",
  "[text-shadow:var(--discover-label-shadow)]"
);

export const discoverMapLabelTextEmphasized = cn(
  discoverMapLabelText,
  "font-bold underline decoration-2 underline-offset-[3px]"
);

export const discoverMapLabelFlying = cn(
  "absolute whitespace-nowrap will-change-[left,top,transform,opacity]"
);

export const discoverMapLabelTextFlying = cn(
  discoverMapLabelText,
  "text-2xl font-semibold leading-snug"
);

export const discoverMapLabelSettled = cn(
  "absolute overflow-visible -translate-x-1/2 -translate-y-full whitespace-nowrap"
);

export const discoverMapLabelPlaced = cn(
  "absolute overflow-visible whitespace-nowrap transition-opacity duration-150"
);

export const discoverMapLabelLeaderLayer =
  "pointer-events-none absolute inset-0 z-0 overflow-visible";

export const discoverMapLabelItemsLayer = "absolute inset-0 z-[1] overflow-visible";
...
export const mapSidePanels =
  "pointer-events-none absolute inset-y-0 right-0 z-[3] flex w-[min(18rem,42vw)] flex-col max-md:hidden";
...
export const mapInfoMobileSheet = cn(
  "pointer-events-auto flex max-h-[min(70vh,34rem)] flex-col overflow-hidden rounded-t-xl border border-b-0 border-border bg-surface shadow-lg",
  "animate-[modal-card-in_0.26s_var(--ease-out)_both]"
);

export const mapInfoMobileSheetHeader =
  "flex shrink-0 items-center justify-between gap-3 border-b border-border px-4 py-2.5";
...
export const mapInfoMobileSheetBody =
...
export const discoverCountrySheetRoot =
  "pointer-events-none absolute inset-x-0 bottom-0 z-[4] flex flex-col md:hidden";

export const discoverCountrySheet = cn(
  "pointer-events-auto flex max-h-[min(55vh,22rem)] flex-col overflow-hidden rounded-t-xl border border-b-0 border-border bg-surface shadow-lg",
  "pb-[env(safe-area-inset-bottom)] animate-[modal-card-in_0.26s_var(--ease-out)_both]"
);

export const discoverCountrySheetHeader =
  "flex shrink-0 items-start justify-between gap-3 border-b border-border px-4 py-3";

export const discoverCountrySheetTitle =
  "m-0 text-[1.15rem] font-bold leading-tight text-text";

export const discoverCountrySheetBody =
  "min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 py-3 [-webkit-overflow-scrolling:touch]";

export const discoverCountrySheetMeta = "m-0 flex flex-col gap-2";

export const discoverCountrySheetRow = "grid grid-cols-[6.5rem_1fr] items-baseline gap-2";

export const discoverCountrySheetLabel =
  "text-[0.72rem] font-bold uppercase tracking-wide text-text-muted";

export const discoverCountrySheetValue = "m-0 text-[0.98rem] font-semibold text-text";

export const discoverCountrySheetFact =
  "mt-3.5 border-t border-border pt-3.5";

export const discoverCountrySheetFactLabel =
  "m-0 mb-1.5 text-[0.72rem] font-bold uppercase tracking-wide text-accent";

export const discoverCountrySheetFactText =
  "m-0 text-[0.92rem] leading-snug text-text-secondary";

export const discoverCountrySheetEmpty =
  "m-0 mt-3.5 border-t border-border pt-3.5 text-[0.88rem] text-text-muted";
...
export function mapSidePanel({ open, className } = {}) {
  return cn(
    "pointer-events-auto flex min-h-0 flex-col overflow-hidden border-l border-border bg-surface shadow-lg",
    ...
    open ? "md:flex-1 md:rounded-none md:border-b-0" : "md:shrink-0",
    className
  );
}
...
export function mapSidePanelHeader({ open, className } = {}) {
  return cn(
    "flex shrink-0 items-center justify-between gap-3 border-b border-transparent px-[0.85rem] py-[0.65rem] transition-[border-color] duration-150",
    open && "border-border",
    className
  );
}
...
export function mapSidePanelBody({ open, className } = {}) {
  return cn(
    ...
    open
      ? "max-h-[min(70vh,24rem)] overflow-y-auto py-3 opacity-100 max-md:max-h-[min(36vh,16rem)] md:max-h-none md:min-h-0 md:flex-1"
      : "max-h-0 py-0 opacity-0",
    className
  );
}

export const learnMoreReference = "flex flex-col gap-2.5";

export const learnMoreTabs = "mt-4 flex gap-1 border-b border-border";

export function learnMoreTab({ active = false, className } = {}) {
  return cn(
    "-mb-px cursor-pointer border-0 bg-transparent px-2.5 py-1.5 text-[0.8rem] font-bold uppercase tracking-wide text-text-muted",
    "transition-[color,box-shadow] duration-150 ease-out hover:text-text",
    active && "text-text shadow-[inset_0_-2px_0_0_var(--color-accent)]",
    focusRing,
    className
  );
}

export const learnMoreTabPanel = "mt-3.5";

export const countryHintHeader = "mb-2 flex items-center justify-between gap-2";

export const hintInfoRow = "flex min-w-0 items-center gap-1.5";

export const hintInfo = "group relative inline-flex";

export const hintInfoIcon = cn(
  "flex h-4 w-4 cursor-help items-center justify-center rounded-full border border-border text-[0.62rem] font-bold italic leading-none text-text-muted",
  "transition-[color,border-color] duration-150 ease-out hover:border-border-subtle hover:text-text",
  focusRing
);

export const hintInfoTooltip = cn(
  "pointer-events-none absolute left-0 top-full z-10 mt-1.5 w-[13.5rem] rounded-sm border border-border bg-surface px-2.5 py-2",
  "text-[0.78rem] font-medium not-italic leading-snug text-text-secondary opacity-0 shadow-lg",
...
export function sbResultAddBtn({ added = false, pending = false } = {}) {
  return cn(
...
export const sbPendingRow =
  "flex items-center gap-3.5 rounded-xl border border-transparent px-2 py-4 max-md:gap-3 max-md:px-1.5 [&+&]:border-t [&+&]:border-t-border/70";

export const sbPendingLabel =
  "shrink-0 text-[0.9rem] font-medium text-text-muted";

export const sbRequestSection =
  "border-t border-border/70 pt-2";

export const sbRequestHeading =
  "px-2 pb-1 pt-3 text-[0.82rem] font-semibold uppercase tracking-[0.04em] text-text-muted";

export const sbRequestActions = "flex shrink-0 items-center gap-2";

export function sbRequestActionBtn({ variant = "accept" } = {}) {
  return cn(
    "inline-flex cursor-pointer items-center rounded-pill border px-3 py-1.5 text-[0.82rem] font-semibold",
    "transition-[background,border-color,color] duration-150 ease-out disabled:cursor-not-allowed disabled:opacity-60",
    variant === "accept"
      ? "border-success/40 bg-success/12 text-success hover:bg-success/20"
      : "border-border bg-surface text-text-muted hover:border-border-subtle hover:bg-menu-hover hover:text-text",
    focusRing
  );
}
...
// — Mastery page —
export const masteryPage = "min-h-dvh bg-background text-text";
...
export const masteryBack =
  "mb-4 inline-block font-medium text-text-muted no-underline transition-colors duration-150 hover:text-text";
...
export const masterySubtitle = "mt-1.5 text-[1.05rem] text-text-muted";

export const masteryMessage = "text-base text-text-secondary";

export const masteryMessageError = "text-error";
...
export const masteryMapWrap =
  "mastery-map-wrap relative h-[min(64vh,38rem)] overflow-hidden rounded-lg border border-border shadow-md";
...
export const masteryPanel =
  "flex flex-col items-center gap-4 rounded-lg border border-border bg-surface p-5 max-md:p-4";

export const masteryRing = "h-36 w-36";

export const masteryRingTrack = "fill-none stroke-[10] stroke-border";
...
export const masteryRingValue =
  "fill-[var(--color-text)] text-[1.6rem] font-extrabold [text-anchor:middle]";

export const masteryRingLabel =
  "fill-[var(--color-text-muted)] text-[0.7rem] font-semibold uppercase tracking-[0.08em] [text-anchor:middle]";

export const masteryStatLine =
  "m-0 text-center text-base leading-snug text-text-muted [&_strong]:text-2xl [&_strong]:text-text";

export const masteryLegend =
  "flex w-full flex-col gap-2 border-t border-border pt-2";

export const masteryLegendTitle =
  "text-[0.75rem] font-bold uppercase tracking-[0.08em] text-text-muted";

export const masteryLegendRow =
  "flex items-center gap-2 text-[0.85rem] text-text-secondary [&_em]:ml-auto [&_em]:font-bold [&_em]:not-italic [&_em]:text-text";
