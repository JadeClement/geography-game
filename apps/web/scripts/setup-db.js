...
ALTER TABLE users ADD COLUMN IF NOT EXISTS game_tour_completed_at TIMESTAMPTZ;
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS mobile_token_hash TEXT;
ALTER TABLE users ADD COLUMN IF NOT EXISTS mobile_token_expires_at TIMESTAMPTZ;
CREATE INDEX IF NOT EXISTS users_mobile_token_idx
  ON users (mobile_token_hash)
