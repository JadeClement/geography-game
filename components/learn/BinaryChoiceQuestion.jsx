 ...
 */
export default function BinaryChoiceQuestion({ question, onAnswer, resolveCountry }) {
  ...
  const handleSelect = (countryId) => {
    ...
    timerRef.current = setTimeout(() => {
      onAnswer?.({ correct, responseTimeMs, revealUsed: false, timedOut: false, selectedValue: countryId });
    }, FEEDBACK_DELAY_MS);
  };
