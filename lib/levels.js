...
export const LEVEL_SECTIONS = [
  {
    ...
    shortTitle: "Find",
    subtitle:
      "Given a country title, click the country on the map as fast as possible.",
    levels: [
      {
  ...
  },
  {
    ...
    shortTitle: "Name",
    subtitle:
      "Given a highlighted country on the map, type the country's name into the box as fast as you can.",
    levels: [
      {
