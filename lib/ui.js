...
export const appHeaderTitle = "font-brand text-[2.1rem] font-light text-[#f0fdfa]";
...
export const startTitleGlobe =
  "start-title-globe relative z-[1] font-brand m-0 text-center font-light leading-[1.05] tracking-[0.02em] text-[clamp(9rem,28vw,14rem)]";
