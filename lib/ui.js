...
export const gameHeader =
  "grid shrink-0 grid-cols-[1fr_auto_1fr] items-center gap-4 border-b border-border bg-header px-4 py-3 backdrop-blur-[12px] backdrop-saturate-[140%] max-md:grid-cols-1 max-md:gap-y-2 max-md:px-3.5 max-md:py-2.5 max-md:[grid-template-areas:'right'_'center']";
