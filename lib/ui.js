...
export const startHeroTitleGroup = "flex flex-col items-center gap-0 max-md:pb-1";
...
export function startModeBtn({ selected = false, disabled = false, className } = {}) {
  return cn(
    ...
    "border-2 border-accent/20 bg-accent-soft/40 shadow-none",
    "enabled:hover:border-accent/35 enabled:hover:bg-accent-soft/60 enabled:hover:shadow-sm",
    selected &&
      "border-accent/35 bg-accent-soft text-text shadow-none focus-visible:outline-none enabled:hover:border-accent/55 enabled:hover:bg-accent-soft/80",
    className
  );
}
