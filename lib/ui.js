...
export const modalOverlay =
  "fixed inset-0 z-50 flex animate-[modal-overlay-in_0.2s_var(--ease-out)_both] items-center justify-center bg-overlay p-4 backdrop-blur-sm";

export const modalCard =
  "relative w-full max-w-sm animate-[modal-card-in_0.26s_var(--ease-out)_both] rounded-lg border border-border bg-surface p-7 shadow-lg";
...
export const gameMetaTag =
  "rounded-pill bg-meta px-2.5 py-1 text-[0.78rem] font-semibold tracking-wide text-text-secondary";
...
export const appHeader =
  "flex shrink-0 items-center justify-between border-b border-[var(--color-header-teal-border)] bg-app-header px-4 py-2.5 text-emerald-50";
...
export const appHeaderTitle = "font-brand text-[2.1rem] font-normal text-[#f0fdfa]";

export const appHeaderSubtitle =
  "text-[0.65rem] font-medium tracking-[0.08em] text-[rgba(240,253,250,0.85)]";
...
export const dropdownItem = cn(
  ...
  "transition-[background] duration-150 ease-out hover:bg-menu-hover",
  focusRing
);
...
export const settingsContent = "mx-auto w-full max-w-xl flex-1 px-4 pb-8 pt-6";

export const settingsBack =
  "mb-4 inline-block text-[0.9rem] font-semibold text-link no-underline hover:underline";

export const settingsTitle = "mb-6 text-[1.75rem] font-bold";

export const settingsSection =
  "rounded-lg border border-border bg-surface p-6 shadow-md [&+&]:mt-4";
...
export function themeToggleBtn({ selected = false } = {}) {
  return cn(
    ...
    "transition-[background,border-color,color,box-shadow] duration-150 ease-out hover:bg-menu-hover hover:text-text",
...
export const startBackArrow = cn(
  ...
  "active:translate-x-0 active:shadow-sm max-md:left-3 max-md:top-3",
  focusRing
);

export const startScreen =
  "flex w-full flex-1 flex-col items-center justify-center gap-6 overflow-x-hidden overflow-y-auto px-8 py-10 animate-[start-screen-in_0.32s_var(--ease-out)_both] max-md:justify-start max-md:gap-5 max-md:px-5 max-md:pb-8 max-md:pt-[clamp(1.5rem,8vh,4rem)] max-sm:gap-5 max-sm:px-4 max-sm:py-6";

export const startScreenSub =
  "relative items-center justify-start gap-5 px-8 pb-10 pt-4 max-md:px-5 max-md:pb-8 max-md:pt-3";

export const startScreenWithGlobe = "start-screen--with-globe relative isolate bg-transparent";

export const startScreenExplore = "w-full justify-center";

export const startScreenContent =
  "relative z-[1] flex w-full flex-col items-center gap-8";

export const startHeroTitleGroup = "flex flex-col items-center gap-1";
...
export const startTitle =
  "m-0 text-center text-[clamp(2rem,5vw,2.5rem)] font-extrabold tracking-tight max-md:text-base";

export const startTitleHero =
  "font-brand relative z-[1] text-[clamp(2rem,5vw,2.5rem)] font-normal leading-tight tracking-[0.02em] [text-shadow:0_2px_16px_var(--color-bg),0_0_40px_var(--color-bg)]";

export const startTitleGlobe =
  "start-title-globe relative z-[1] font-brand m-0 text-center font-normal leading-[1.05] tracking-[0.02em] text-[clamp(9rem,28vw,14rem)]";
...
export const startModeRow =
  "grid w-full grid-cols-3 gap-3 p-0.5 [&_.choice-btn]:min-w-0 [&_.choice-btn]:px-3 [&_.choice-btn]:text-[0.95rem]";
...
export const goBtn = cn(
  ...
  "enabled:active:translate-y-0 disabled:cursor-default disabled:opacity-60",
  focusRing
);
...
export const exploreBtn = "w-full items-center text-center";

// — Game layout —
export const gameShell = "flex h-dvh flex-col";

export const gameHeader =
  "grid shrink-0 grid-cols-[1fr_auto_1fr] items-center gap-4 border-b border-border bg-header px-4 py-3 backdrop-blur-[12px] backdrop-saturate-[140%] max-md:grid-cols-[auto_1fr] max-md:gap-x-3 max-md:gap-y-2 max-md:px-3.5 max-md:py-2.5 max-md:[grid-template-areas:'left_right'_'center_center']";

export const gameHeaderLeft =
  "flex items-center justify-self-start gap-3 max-md:[grid-area:left] max-md:flex-wrap max-md:gap-2";

export const gameHeaderCenter =
  "justify-self-center text-center max-md:[grid-area:center] max-md:w-full max-md:justify-self-stretch";

export const gameHeaderRight =
  "flex items-center justify-self-end gap-4 max-md:[grid-area:right] max-md:gap-2.5";
...
export const gameProgress =
  "h-[0.35rem] w-[clamp(3.5rem,10vw,6.5rem)] shrink-0 overflow-hidden rounded-pill bg-inset max-md:w-[clamp(2.75rem,12vw,4.5rem)]";
...
export const gameControlBtn = cn(
  "inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm border border-border-subtle bg-surface p-0 text-text-menu",
  "transition-[background,border-color,transform] duration-150 ease-out hover:bg-menu-hover hover:border-border-subtle active:scale-[0.96]",
  focusRing
);
...
export const scoreboard =
  "flex flex-col items-end gap-0.5 text-[0.95rem] font-semibold max-sm:text-[0.85rem]";
...
export const mapSidePanels =
  "pointer-events-none absolute right-0 top-0 z-[3] flex w-[min(18rem,42vw)] flex-col max-md:bottom-0 max-md:left-0 max-md:right-0 max-md:top-auto max-md:w-full";

export const flagCard =
  "pointer-events-none absolute left-4 top-4 z-[2] rounded-md border border-border bg-surface p-2.5 shadow-lg backdrop-blur-[10px]";
...
export function mapFeedback({ type, className } = {}) {
  const base = cn(
    "pointer-events-none absolute left-1/2 top-5 z-[2] flex max-w-[min(90vw,26rem)] -translate-x-1/2 items-center gap-2.5 whitespace-nowrap rounded-full",
...
export const mapFeedbackText = "pr-0.5";

export function flagPrompt({ card = false, className } = {}) {
  return cn(
    "block rounded border border-border object-cover shadow-sm",
    card
      ? "aspect-[3/2] h-auto w-[min(42vw,15rem)] rounded-[0.35rem] border-0 shadow-none"
      : "h-11 w-auto rounded",
    className
  );
}
...
export function mapSidePanelBody({ open, className } = {}) {
  return cn(
    ...
    open
      ? "max-h-[min(70vh,24rem)] overflow-y-auto py-3 opacity-100 max-md:max-h-[min(42vh,20rem)]"
...
export const resultsContent = "mx-auto w-full max-w-4xl flex-1 px-4 pb-10 pt-6";

export const resultsBack =
  "mb-4 inline-block text-[0.9rem] font-semibold text-link no-underline hover:underline";

export const resultsTitle = "mb-1.5 text-[1.75rem] font-bold";
...
export const resultsSection =
  "flex flex-col gap-3 rounded-lg border border-border bg-surface p-6 shadow-md";
...
export const resultsTableRowHeader =
  "whitespace-nowrap bg-inset text-left font-semibold text-text-secondary";
...
export const masteryContent =
  "mx-auto max-w-6xl px-[clamp(1rem,4vw,2rem)] pb-12 pt-6";
...
export const masteryTitle =
  "m-0 bg-gradient-to-r from-cyan-400 via-purple-400 to-amber-400 bg-clip-text text-[clamp(1.75rem,4vw,2.5rem)] font-extrabold tracking-tight text-transparent";
...
export function masteryTab({ active = false, className } = {}) {
  return cn(
    ...
    "transition-[color,background,border-color] duration-150 hover:bg-slate-400/10 hover:text-slate-200",
...
export const masteryShare = "shrink-0";

export const masteryStage =
  "grid grid-cols-1 items-start gap-5 lg:grid-cols-[minmax(0,1fr)_16rem]";

export const masteryMapWrap =
  "relative h-[min(64vh,38rem)] overflow-hidden rounded-lg border border-slate-400/20 shadow-[0_24px_60px_-24px_rgba(0,0,0,0.8)]";
...
export const masteryPanel =
  "flex flex-col items-center gap-4 rounded-lg border border-slate-400/15 bg-slate-900/50 p-5";
...
export const pacificMapControlBtn = cn(
  "flex h-8 w-8 cursor-pointer items-center justify-center rounded-sm border border-border bg-surface p-0 text-base font-semibold leading-none text-text shadow-md transition-[background] duration-150 hover:bg-menu-hover",
  focusRing
);
...
export const pacificMapControls =
  "pointer-events-auto absolute bottom-3 right-3 z-[4] flex flex-col gap-1.5";
