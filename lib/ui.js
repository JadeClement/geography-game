...
export const appHeader =
  "flex shrink-0 items-center justify-between border-b border-[var(--color-header-teal-border)] bg-app-header px-4 py-2.5 text-emerald-50 max-md:px-3 max-md:py-2 max-md:pt-[max(0.5rem,env(safe-area-inset-top))]";
...
export const startScreenContent =
  "relative z-[1] flex w-full flex-col items-center gap-8 max-md:gap-5 max-sm:gap-4";
...
export const goBtn = cn(
  ...
  "enabled:active:translate-y-0 disabled:cursor-default disabled:opacity-60 max-sm:w-full",
  focusRing
);
...
export const scoreboard =
  "flex flex-col items-end gap-0.5 text-[0.95rem] font-semibold max-sm:items-start max-sm:text-[0.8rem]";
...
export const mapSidePanels =
  "pointer-events-none absolute right-0 top-0 z-[3] flex w-[min(18rem,42vw)] flex-col max-md:bottom-[env(safe-area-inset-bottom)] max-md:left-0 max-md:right-0 max-md:top-auto max-md:w-full";
